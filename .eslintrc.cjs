...
module.exports = {
  ...
  overrides: [
    // sometimes we may not want to apply the same rows to our files we can use special rows for specific file by adding this array
    {
